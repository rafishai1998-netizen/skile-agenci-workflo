/**
 * Footer — dark band, 5-column: mascot/brand, Services, Areas, About, Contact.
 * Roboto Condensed 700 uppercase column headings.
 */
const COLS: Array<{ heading: string; links: string[] }> = [
  ...
  },
  {
    ...
    links: ["Spring", "The Woodlands", "Conroe", "Houston", "Cypress", "Tomball"],
  },
  {
    heading: "About",
  ...
  },
  {
    ...
    links: ["(281) 350-BEAR", "Mon-Fri 8am-5pm", "contact@{{BRAND_DOMAIN}}", "{{ADDRESS_LINE_1}}", "{{ADDRESS_LINE_2}}"],
  },
];

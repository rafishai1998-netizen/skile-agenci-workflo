/**
 * Footer — black band, 4 columns: brand + contact | navigate | portfolio |
 * legal. Italic-gold section headings, muted cream body. Mirrors Cinco's
 * deep-green footer but in the premium-design-build black palette.
 */
export default function Footer() {
  const nav = ["Services", "Portfolio", "About", "Process", "Journal", "Contact"];
  const portfolio = ["Residential", "Commercial", "Pool &amp; Spa", "Commissioned Gardens"];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 pb-14 border-b border-brand-cream/10">
          <div className="col-span-2">
            ...
            <p className="italic-accent text-italic-accent-sm text-brand-gold-soft mb-5">
              commissioned outdoor architecture.
            </p>
          ...
          <div>
            <p className="italic-accent text-[16px] text-brand-gold-soft mb-4">Portfolio</p>
            <ul className="space-y-2 text-body-base">
              {portfolio.map((p) => (
                <li key={p}>

...
export default function Hero({
  eyebrow = '#1 Rated Company In The [METRO] Area',
  headlineLead = 'High Quality',
  headlineAccent = 'Concrete Coatings',
  headlineTrail = 'Done In One Day!',
  subhead = 'Turn your old garage, patio, or commercial floor into a beautiful and functional masterpiece. 100% satisfaction guaranteed.',
  imageUrl = '/placeholder-garage.svg',
}: Props) {
  return (

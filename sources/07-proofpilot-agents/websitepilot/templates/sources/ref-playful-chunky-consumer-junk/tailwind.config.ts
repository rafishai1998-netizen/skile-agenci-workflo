...
/**
 * Santa-Banana-derived DNA — playful-chunky-consumer + JUNK-REMOVAL nudge.
 *
 * Base palette is unchanged from ref-playful-chunky-consumer; one extra
 * stop is added — `brand.go` lime — to give the junk vertical the extra
 * "GO ENERGY" the brief asks for. Use lime for "PICK UP TODAY" badges,
 * photo-tile featured chips, and the price-band highlight; do not let
 * lime replace yellow as the primary CTA fill.
 *
 ...
 *   brand.go         — junk-vertical lime "go-energy" accent (badges + chips only).
    ...
    extend: {
      colors: {
        brand: {
          ...
          accentInk:  "#FFFFFF",
          go:         "#9CD60F", // junk-vertical lime "go-energy" badge / chip color
          goInk:      "#0B1A0A", // ink on lime

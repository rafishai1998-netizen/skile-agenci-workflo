    ...
    <footer className="section-darker">
      <div className="mx-auto max-w-[1320px] px-6 py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-brand-onDarkMuted text-[15px]">
            <li><a href="#services" className="hover:text-white">Residential Lighting</a></li>
            <li><a href="#services" className="hover:text-white">Commercial Lighting</a></li>
            <li><a href="#services" className="hover:text-white">Year-Round Storage</a></li>
            <li><a href="#services" className="hover:text-white">Free Maintenance</a></li>
          </ul>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-[1320px] px-6 py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-2 text-brand-onDarkMuted text-[13px]">
          <div>© {/* {{BRAND-NAME-L1}} */}Placeholder Lighting Co. All rights reserved.</div>
